...
one_on_lambda_squared_t1_in_SI = []
for lambda_t1_in_m_element in lambda_t1_in_m:
    one_on_lambda_squared_t1_in_SI.append(round(1/(lambda_t1_in_m_element**2), -9))

one_on_lambda_squared_t1_in_one_on_micrometer_squared = [one_on_lambda_squared_t1_in_SI_element * (10**-12) for one_on_lambda_squared_t1_in_SI_element in one_on_lambda_squared_t1_in_SI]
print("one_on_lambda_squared_t1_in_one_on_micrometer_squared =", one_on_lambda_squared_t1_in_one_on_micrometer_squared, "1/μm^2")
...
model_1.fit(x_experimental_t1_in_mm, one_on_lambda_squared_t1_in_one_on_micrometer_squared)
plt.figure(figsize=(7, 7))
plt.scatter(x_experimental_t1_in_mm, one_on_lambda_squared_t1_in_one_on_micrometer_squared, color='red')
...
intercept_p1_Hg_in_one_on_micrometer_squared = model_1.intercept_

print("slope_p1_Hg_in_10e15_m_minus3 =", round(slope_p1_Hg_in_10e15_m_minus3, 3), "* 10^15 m^-3")
print("intercept_p1_Hg_in_one_on_micrometer_squared =", round(intercept_p1_Hg_in_one_on_micrometer_squared, 3), "(1/μm^2)")

x_experimental_t2_in_mm = [x_experimental_t2_in_m_element * (10**3) for x_experimental_t2_in_m_element in x_experimental_t2_in_m]

# Compute 1/Î»^2 values for hydrogen
one_on_lambda_squared_t2_in_one_on_micrometer_squared = []
for x_experimental_t2_in_mm_element in x_experimental_t2_in_mm:
    one_on_lambda_squared_t2_in_one_on_micrometer_squared.append(slope_p1_Hg_in_10e15_m_minus3 * x_experimental_t2_in_mm_element + intercept_p1_Hg_in_one_on_micrometer_squared)

one_on_lambda_squared_Hg_and_H_in_one_on_micrometer_squared = one_on_lambda_squared_t1_in_one_on_micrometer_squared + one_on_lambda_squared_t2_in_one_on_micrometer_squared
one_on_lambda_squared_Hg_and_H_in_one_on_micrometer_squared.sort()
...
model_2.fit(x_experimental_t2_in_mm, one_on_lambda_squared_t2_in_one_on_micrometer_squared)
plt.figure(figsize=(7, 7))
plt.scatter(x_experimental_t2_in_mm, one_on_lambda_squared_t2_in_one_on_micrometer_squared, color='blue')
...
plt.scatter(x_experimental_t1_in_mm, one_on_lambda_squared_t1_in_one_on_micrometer_squared, color='red', label="Mercury")

# Experimental points for hydrogen
plt.scatter(x_experimental_t2_in_mm, one_on_lambda_squared_t2_in_one_on_micrometer_squared, color='blue', label="Hydrogen")
...
model_3.fit(x_experimental_Hg_and_H_in_mm, one_on_lambda_squared_Hg_and_H_in_one_on_micrometer_squared)
...
one_on_lambda_squared_t2_in_SI = [one_on_lambda_squared_t2_in_one_on_micrometer_squared_element * (10**12) for one_on_lambda_squared_t2_in_one_on_micrometer_squared_element in one_on_lambda_squared_t2_in_one_on_micrometer_squared]
lambda_t2_in_m = []
for one_on_lambda_squared_t2_in_SI_element in one_on_lambda_squared_t2_in_SI:
    lambda_t2_in_m.append(round(math.sqrt(1/one_on_lambda_squared_t2_in_SI_element), 10))
