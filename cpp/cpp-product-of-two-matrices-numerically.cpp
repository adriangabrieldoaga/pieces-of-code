...
int main()
{
    ...
    cout << "Number of lines of first matrix: ";
    cin >> l1;
    cout << "Number of columns of first matrix: ";
    cin >> c1;
    cout << "Number of lines of second matrix: ";
    cin >> l2;
    ...
    // The product matrix will have as many lines as the first matrix and as
    // many columns as the second matrix. Elements must be initialized with
    ...
    for (i = 0; i < l1; i++)
    {
        for (j = 0; j < c2; j++)
        {
            ...
            for (k = 0; k < c1; k++)
            {
                ...
                // Add the products between the elements of the lines and
                // the columns, one by one, in an element of the product
